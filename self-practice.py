...
# print(100 / 2 ** 2)
# ===========================
# Вывод показателей электронных часов, в инпут получаем любое количесвто секунд
# n = int(input())
# d = n // 86400
# h = (n-d*86400) // 3600
# mm = (n - d*86400 - h*3600) // 60
# s = (n - d*86400 - h*3600 - mm*60) % 60
# min = str(mm).zfill(2) # -->> метод вывода в формате 00:00
# sec = str(s).zfill(2)
# print(h, min, sec, sep=':') # ===>>> верное решение!
